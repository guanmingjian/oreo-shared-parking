...
import cn.oreo.common.util.constant.CommonConstant;
...
public class SortUtil {
     ...
     */
    public static void handleWrapperPageSort(Object object, QueryRequest request, Page<?> page, QueryWrapper<?> wrapper, String defaultSort, boolean camelToUnderscore) {
    ...
    public static void handlePageSort(QueryRequest request, Page<?> page, String defaultSort, String defaultOrder, boolean camelToUnderscore) {
        ...
        if (camelToUnderscore) {
            sortField = OreoUtil.camelToUnderscore(sortField);
            defaultSort = OreoUtil.camelToUnderscore(defaultSort);
        }
        if (StringUtils.isNotBlank(request.getField())
            ...
            if (StringUtils.equals(request.getOrder(), CommonConstant.ORDER_DESC)) {
