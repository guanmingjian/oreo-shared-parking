...
import cn.oreo.server.system.mapper.LoginLogMapper;
import cn.oreo.server.system.service.ILoginLogService;
import cn.oreo.server.system.utils.AddressUtil;
...
public class LoginLogServiceImpl extends ServiceImpl<LoginLogMapper, LoginLog> implements ILoginLogService {
    ...
    public IPage<LoginLog> findLoginLogs(LoginLog loginLog, QueryRequest request) {
        ...
        SortUtil.handlePageSort(request, page, "loginTime", OreoConstant.ORDER_DESC, true);
