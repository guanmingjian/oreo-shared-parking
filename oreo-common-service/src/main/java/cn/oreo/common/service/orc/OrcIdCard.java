package cn.oreo.common.service.orc;
...
public class OrcIdCard {
    ...
    /**
     *  身份证识别
     * @param imgFile   身份证图片路径
     * @param side      font：正面     back：反面
     * @return  JsonObject
     */
    public JSONObject OrcGetJson(String imgFile,String side){
        String host = "https://dm-51.data.aliyun.com";
        String path = "/rest/160601/ocr/ocr_idcard.json";
        String appcode = "f79e77eceba245a3a0178b8e2f9c891b";
        String method = "POST";
