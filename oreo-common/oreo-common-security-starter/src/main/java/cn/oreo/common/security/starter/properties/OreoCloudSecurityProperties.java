package cn.oreo.common.security.starter.properties;
 ...
 * @since 2020/10/4
 */
@ConfigurationProperties(prefix = "oreo.cloud.security")
public class OreoCloudSecurityProperties {
    ...
    public String toString() {
        return "OreoCloudSecurityProperties{" +
                "enable=" + enable +
                ", authUri='" + authUri + '\'' +
                ", anonUris='" + anonUris + '\'' +
