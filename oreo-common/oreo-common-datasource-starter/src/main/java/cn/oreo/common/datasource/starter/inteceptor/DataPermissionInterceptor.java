package cn.oreo.common.datasource.starter.inteceptor;

import cn.oreo.common.core.entity.CurrentUser;
import cn.oreo.common.core.utils.OreoUtil;
import cn.oreo.common.datasource.starter.annotation.DataPermission;
...
public class DataPermissionInterceptor extends AbstractSqlParserHandler implements Interceptor {
    ...
    private String dataPermissionSql(String originSql, DataPermission dataPermission) {
        try {
            ...
            CurrentUser user = OreoUtil.getCurrentUser();
            if (user == null) {
                return originSql;
            }
