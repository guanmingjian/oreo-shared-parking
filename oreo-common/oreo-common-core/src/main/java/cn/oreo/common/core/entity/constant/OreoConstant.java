package cn.oreo.common.core.entity.constant;
...
public interface OreoConstant {
     ...
     * Gateway请求头TOKEN值
     */
    String GATEWAY_TOKEN_VALUE = "oreo:gateway:123456";
     ...
     * 验证码 key前缀
     */
    String CODE_PREFIX = "oreo.captcha.";

    /**
     * 异步线程池名称
     */
    String ASYNC_POOL = "oreoAsyncThreadPool";
