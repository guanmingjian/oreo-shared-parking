package cn.oreo.gateway.common.handler;
 ...
 */
@Slf4j
public class OreoGatewayExceptionHandler extends DefaultErrorWebExceptionHandler {

    public OreoGatewayExceptionHandler(ErrorAttributes errorAttributes, ResourceProperties resourceProperties,
