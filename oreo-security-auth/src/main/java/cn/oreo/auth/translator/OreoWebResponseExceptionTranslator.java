package cn.oreo.auth.translator;
...
public class OreoWebResponseExceptionTranslator implements WebResponseExceptionTranslator {

    @Override
    public ResponseEntity<?> translate(Exception e) {
        ResponseEntity.BodyBuilder status = ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR);
        OreoResponse response = new OreoResponse();
        String message = "认证失败";
        log.error(message, e);
